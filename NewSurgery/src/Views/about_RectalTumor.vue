            ...
            <el-col :span="6">
              <el-form-item label="手术部位(surgery site)" prop="surgerySite">
                <el-select v-model="generalInfo.surgerySite">
                  <el-option label="直肠(rectum)" value="直肠"></el-option>
                </el-select>
              </el-form-item>
            </el-col>
            ...
            <el-col :span="6">
              <el-form-item label="手术名称(surgery name)" prop="surgeryName">
                <el-select v-model="generalInfo.surgeryName" placeholder="请选择手术名称">
                  <el-option label="直肠切除术(rectal resection)" value="直肠切除术"></el-option>
...
<!--                  <el-option label="第五级" value="第五级"></el-option>-->
        ...
        <el-form ref="labTests" :model="labTests" :rules="rules1" label-position="top">
          ...
          <el-row :gutter="20">
            ...
            <el-col :span="8">
              <el-form-item label="甲状腺激素(thyroid hormone) mIU/L" prop="thyroid">
            ...
            <el-col :span="8">
              <el-form-item label="CA125(cancer antigen 125) U/mL" prop="CA125">
                <el-input v-model="labTests.CA125" placeholder="请输入"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
              <el-form-item label="糖类抗原19-9_CA19-9(carbohydrate antigen 19-9) U/mL" prop="antigen19">
                <el-input v-model="labTests.antigen19" placeholder="请输入"></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8">
            ...
            <el-col :span="8">
              <el-form-item label="病毒性肝炎标志物(viral hepatitis markers) IU/ml" prop="viral">
                <el-input v-model="labTests.viral" placeholder="请输入"></el-input>
              </el-form-item>
            </el-col>
...
// 结肠单独的指标
    ...
    handle() {
      ...
      console.log(this.generalInfo.patientName);
