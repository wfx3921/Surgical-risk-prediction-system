            ...
            <el-col :span="6">
              <el-form-item label="手术部位(surgery site)" prop="surgerySite">
                <el-select v-model="generalInfo.surgerySite">
                  <el-option label="胃(stomach)" value="胃"></el-option>
                </el-select>
              </el-form-item>
            </el-col>
            ...
            <el-col :span="6">
              <el-form-item label="手术名称(surgery name)" prop="surgeryName">
                <el-select v-model="generalInfo.surgeryName" placeholder="请选择手术名称">
                  <el-option label="腹腔镜远端胃切除术(laparoscopic distal gastrectomy)" value="腹腔镜远端胃切除术"></el-option>
  ...
  data() {
    return {
      ...
      rules2: {
        ...
        hypotensionWithin48Hours: [
          { required: true, message: '请选择手术前48小时内血压下降', trigger: 'change' }
        ],
        preoperativePeritonitis: [
          { required: true, message: '请选择手术前腹膜炎', trigger: 'change' }
        ]
      }
      ...
      request.get(`/patientdata/getPatientData/${row.userId}`)
        .then(response => {
          ...
          this.generalInfo.caseNumber = response.data.data.hospitalizationNumber,
            ...
            this.labTests.albumin1 = response.data.data.albumin1,
...
// 直肠单独的指标(设置为空)
        CA125: this.labTests.CA125,           // CA125(cancer antigen 125) U/mL
        ...
        hypotensionWithin48Hours: this.auxiliaryExams.hypotensionWithin48Hours,
        preoperativePeritonitis: this.auxiliaryExams.preoperativePeritonitis,
