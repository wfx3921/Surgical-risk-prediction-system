              ...
              <el-col :span="6">
                <el-form-item label="手术部位" prop="surgerySite">
                  <el-select v-model="generalInfo.surgerySite">
                    <el-option label="胆囊" value="胆囊"></el-option>
                  </el-select>
                </el-form-item>
              </el-col>
              ...
              <el-col :span="6">
                <el-form-item label="手术名称" prop="surgeryName">
                  <el-select v-model="generalInfo.surgeryName" placeholder="请选择手术名称">
                    <el-option label="胆囊切除术" value="胆囊切除术"></el-option>
  ...
  <!--                  <el-option label="第五级" value="第五级"></el-option>-->
          ...
          <el-form ref="labTests" :model="labTests" :rules="rules1">
            ...
            <el-row :gutter="20">
              ...
              <el-col :span="8">
                <el-form-item label="血清总胆红素" prop="totalBilirubin">
                  <el-input v-model="labTests.totalBilirubin"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="血清一分钟胆红素" prop="directBilirubin">
                  <el-input v-model="labTests.directBilirubin"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="胆固醇" prop="leukocyte">
                  <el-input v-model="labTests.leukocyte"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="α-谷氨酰转肽酶" prop="electrolytePotassium">
                  <el-input v-model="labTests.electrolytePotassium"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="血沉" prop="bloodSugar">
                  <el-input v-model="labTests.bloodSugar"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="癌胚抗原_CEA" prop="triglyceride">
                  <el-input v-model="labTests.triglyceride"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="糖类抗原19-9_CA19-9" prop="Indirectbilirubin">
                  <el-input v-model="labTests.Indirectbilirubin"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="8">
                <el-form-item label="唾液酸_SA" prop="antithrombin">
                  <el-input v-model="labTests.antithrombin"></el-input>
                </el-form-item>
              </el-col>
  
              <el-col :span="8">
                <el-form-item label="DNA聚合酶_DNA-Plca" prop="bloodUreaNitrogen">
